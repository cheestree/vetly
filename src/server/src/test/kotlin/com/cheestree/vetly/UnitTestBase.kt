...
open class UnitTestBase {
    ...
    private val user2 =
        User(2L, UUID.randomUUID(), "", "Dr. Jane Smith", "jane.smith@example.com", roles = mutableSetOf())
    private val user3 =
        User(3L, UUID.randomUUID(), "", "Dr. Janette Smith", "janette.smith@example.com", roles = mutableSetOf())

    private val userRole1 =
        UserRole(id = UserRoleId(userId = user1.id, roleId = adminRole.id), user = user1, role = adminRole)
