...
import com.cheestree.vetly.domain.model.input.checkup.CheckupInputModel
import com.cheestree.vetly.domain.model.input.checkup.CheckupUpdateInputModel
import com.cheestree.vetly.domain.path.Path.Checkups.CREATE
import com.cheestree.vetly.domain.path.Path.Checkups.DELETE
import com.cheestree.vetly.domain.path.Path.Checkups.GET
import com.cheestree.vetly.domain.path.Path.Checkups.GET_ALL
import com.cheestree.vetly.domain.path.Path.Checkups.UPDATE
import com.cheestree.vetly.domain.user.AuthenticatedUser
import com.cheestree.vetly.services.CheckupService
